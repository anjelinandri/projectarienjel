package com.example.projectarienjel;
...
import com.example.projectarienjel.adapter.MovieListAdapter;
import com.example.projectarienjel.model.Movie;
import com.example.projectarienjel.network.ApiService;
    ...
    private void loadData() {
        ...
        apiService.getNowPlaying(page, new Callback() {
            ...
            public void onResponse(Call call, Response response) {
                ...
                Log.d("Message", "Response Success");
                if(movie != null){
